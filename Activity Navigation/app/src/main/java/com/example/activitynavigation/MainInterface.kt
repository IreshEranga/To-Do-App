...
class MainInterface : AppCompatActivity() {
    ...
    private fun showBottomDialog() {
        ...
        videoLayout.setOnClickListener {
            dialog.dismiss()
            Toast.makeText(this@MainInterface, "Upload a Video is clicked", Toast.LENGTH_SHORT).show()
        }

        shortsLayout.setOnClickListener {
            dialog.dismiss()
            Toast.makeText(this@MainInterface, "Upload Images is Clicked", Toast.LENGTH_SHORT).show()
        }
